...
- Questões difíceis devem ter "pegadinha" identificável`
  },
  {
    ...
    categorySlug: "raciocinio-clinico",
    sectionNumber: 2,
    description: "Conduz simulação interativa de casos clínicos com feedback estruturado em cada etapa do raciocínio diagnóstico, desenvolvendo competências de tomada de decisão",
...
- O erro do estudante é oportunidade de aprendizado`
  },
  {
    ...
    categorySlug: "raciocinio-clinico",
    sectionNumber: 2,
    description: "Aplica metodologia socrática através de perguntas progressivas que guiam o estudante à descoberta autônoma do conhecimento, sem fornecer respostas diretas",
    estimatedTime: "12 min",
    evidenceLevel: "Alta",
    difficulty: "Intermediário",
...
- Sessões curtas e frequentes > sessões longas e esporádicas`
  },
  {
    ...
    categorySlug: "retencao-memoria",
    sectionNumber: 3,
    description: "Desenvolve sessão de prática intercalada que alterna tópicos relacionados de forma imprevisível, forçando discriminação entre conceitos similares e melhorando a transferência de aprendizado",
    estimatedTime: "10 min",
    evidenceLevel: "Alta",
    difficulty: "Intermediário",
...
- Os casos ambíguos são os que mais ensinam`
  },
  {
    ...
    categorySlug: "retencao-memoria",
    sectionNumber: 3,
    description: "Desenvolve técnicas de memorização baseadas em neurociência, incluindo acrônimos, imagens mentais e palácio da memória para conteúdos de anatomia, farmacologia e protocolos clínicos",
    estimatedTime: "8 min",
    evidenceLevel: "Alta",
    difficulty: "Iniciante",
...
- Erros são informação valiosa sobre gaps`
  },
  {
    ...
    categorySlug: "desafio-cognitivo",
    sectionNumber: 5,
    description: "Otimiza material de estudo segundo a Teoria da Carga Cognitiva, eliminando sobrecarga extrínseca e maximizando processamento relevante dentro dos limites da memória de trabalho",
    estimatedTime: "8 min",
    evidenceLevel: "Alta",
    difficulty: "Intermediário",
...
- O melhor horário é o que FUNCIONA para você, não o que os outros fazem`
  },
  {
    ...
    categorySlug: "rotina-performance",
    sectionNumber: 6,
    description: "Desenvolve plano estratégico completo de preparação para provas de medicina e residência, com periodização de 8 semanas integrando todas as técnicas de estudo",
    estimatedTime: "15 min",
    evidenceLevel: "Alta",
    difficulty: "Avançado",
...
- Recompensa semanal por meta cumprida`
  ...
  // SEÇÃO 8: PRODUÇÃO ACADÊMICA
  {
    ...
    sectionNumber: 8,
    description: "Estrutura trabalho de conclusão de curso em medicina com seções no formato IMRD, incluindo metodologia, cronograma e referências-chave para cada etapa do projeto",
    estimatedTime: "15 min",
    evidenceLevel: "Alta",
    difficulty: "Avançado",
...
- Adapte conforme o tipo de conteúdo`
  },
  {
    ...
    categorySlug: "otimizacao-tracking",
    sectionNumber: 10,
    description: "Conduz revisão semanal estruturada de 15 minutos para análise de desempenho, extração de aprendizados e planejamento de ajustes estratégicos baseados em métricas",
    estimatedTime: "15 min",
    evidenceLevel: "Média",
    difficulty: "Intermediário",
